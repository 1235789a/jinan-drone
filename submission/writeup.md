...
Each sample contains a question, two LLM responses (from GPT-4, Claude, Llama-3, DeepSeek, Qwen, etc.), and expert-annotated risk assessments. We deliberately included cases spanning all risk levels: clear hallucinations (high), subtle inaccuracies (medium), and agreeing accurate responses (low).
